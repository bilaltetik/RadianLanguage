...
EXAMPLES = [
    ...
    ("metin_isleme.rad", ["ters      : naidar",
                          "başlık    : Radian Programlama Dili",
                          "çözülmüş  : Radian dili",
                          "en sık        : bir → 4 kez",
                          "tüm doğrulamalar geçti"]),
    ("veri_yapilari.rad", ["tepe      : 3", "([]) → true",
                           "birleşim  : [1, 2, 3, 4, 5]",
                           "acil orta düşük",
                           "tüm doğrulamalar geçti"]),
    ("oyun_hayat.rad", ["nesil 0 — planör", "nesil 4 — canlı: 5",
                        "blinker — nesil 1", "tüm doğrulamalar geçti"]),
    ("matris.rad",     ["A × B =", "  [ 2.0  1.0 ]", "det(A) : -2.0",
                        "C × Cᵀ =", "  [ 14.0  32.0 ]",
                        "satır ortalamaları : [1.5, 3.5]",
                        "tüm doğrulamalar geçti"]),
    ("hesap_makinesi.rad", ["1 + 2 * 3                = 7.0",
                            "2 ^ 3 ^ 2                = 512.0",
                            'ortam: #["x": 4.0, "y": 9.0]',
                            "tüm doğrulamalar geçti"]),
